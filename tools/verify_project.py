...
def main() -> None:
    ...
    required = [
        ...
        '"Eagle 500kg Bomb":{kind:"eagle-500kg"',
        '"Eagle Airstrike":{kind:"eagle-airstrike"',
        '"Eagle 110mm Rocket Pods":{kind:"eagle-rocket-pods"',
        '"Eagle Strafing Run":{kind:"eagle-strafing"',
        '"Orbital Gatling Barrage":{kind:"gatling-barrage"',
        'name:"E/AT-12 Anti-Tank Emplacement", cat:"Emplacement"',
        "if(!base||base.splash3d===false)return null",
        "function isPatternDelivery",
        ...
        "const showRadii=!impact.suppressExplosion",
